# CTF Challenge: permissions_setting_practice

## Table of Content

- commands-executed: 
- flag :pwn.college{k70iB4KafnR-mHzEtP9e2cHlJ5K.dNTM5QDLzETN0czW}
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=rw,g=w /challenge/pwn
NEEDED, BUT UNMET permissions of "/challenge/pwn": ----w-r--
- the user doesn't have read permissions
- the user doesn't have write permissions
- the user doesn't have execute permissions
- the group doesn't have read permissions
...
CURRENT, INCORRECT permissions of "/challenge/pwn": rw--w-r--
* the user does have read permissions
* the user does have write permissions
- the user doesn't have execute permissions
- the group doesn't have read permissions
...
hacker@permissions~permissions-setting-practice:~$ chmod u=-,g=w /challenge/pwn
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=rw,g=wrx,o=r /challenge/pwn
You set the correct permissions!
Round 4 (of 8)!
...
- the group doesn't have execute permissions
- the world doesn't have read permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=w,g=wr,o=wx /challenge/pwn
You set the correct permissions!
Round 5 (of 8)!
...
- the world doesn't have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod o=rx /challenge/pwn
You set the correct permissions!
Round 7 (of 8)!

Current permissions of "/challenge/pwn": --xrwxr-x
- the user doesn't have read permissions
- the user doesn't have write permissions
* the user does have execute permissions
* the group does have read permissions
