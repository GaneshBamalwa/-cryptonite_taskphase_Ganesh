# CTF Challenge: permission_tweaking_practices

## Table of Content

- commands-executed: 
- flag :pwn.college{Ma3mzQxp_9BUK3KPTz7ZDWN3Gac.dBTM2QDLzETN0czW}
...
* the world does have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod go+wrx /challenge/pwn
You set the correct permissions!
Round 6 (of 8)!
