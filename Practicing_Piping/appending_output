# CTF Challenge: appending_output

## Table of Content

- commands-executed: /challenge/run >> ./the-flag , cat the-flag
- flag :pwn.college{M6qaH-2HgdtmIM-1ydGd_RlhPrg.ddDM5QDLzETN0czW}
...
\|/ This is the first half:
 v 
pwn.college{M6qaH-2HgdtmIM-1ydGd_RlhPrg.ddDM5QDLzETN0czW}
                              ^
